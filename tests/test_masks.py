...
def test_get_mask_card_number(numder_1_1: Union[int], numder_1_2: Union[int], numder_1_3: Union[int]) -> None:
...
def test_get_mask_account(value: Union[int], expected: Union[str]) -> None:
